...
public class ProductKafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, List<ProductDto>> productProducerFactory() {
        return new DefaultKafkaProducerFactory<>(productProducerConfig());
    }

    @Bean
    public KafkaTemplate<String, List<ProductDto>> productKafkaTemplate(
            ProducerFactory<String, List<ProductDto>> producerFactory) {
