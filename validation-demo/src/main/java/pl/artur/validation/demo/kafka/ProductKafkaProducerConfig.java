...
public class ProductKafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, TestModel> productProducerFactory() {
        return new DefaultKafkaProducerFactory<>(productProducerConfig());
    }

    @Bean
    public KafkaTemplate<String, TestModel> productKafkaTemplate(
            ProducerFactory<String, TestModel> producerFactory) {
